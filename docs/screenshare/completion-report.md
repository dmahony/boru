...
**Fix (4 sites, `src/bin/boru/app.rs`):**
...
1. `storage::tests::docs_reference_current_schema_version` — SQLite storage
   ...
   §3 cfg-gate lines in `src/bin/boru/app.rs`). Unrelated to screen

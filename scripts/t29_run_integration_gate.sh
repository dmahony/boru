#!/usr/bin/env bash
# BORU-DISC-29 full integration gate on debsrv via rb.
...
# Usage: bash scripts/t29_run_integration_gate.sh [--default] [--test-utils]
set -uo pipefail
cd "$(dirname "$0")/.."

MODE="${1:---default}"
RESULTS_LOG="docs/discovery-refactor/evidence/t29-gate/integration-gate-${MODE#--}.log"
